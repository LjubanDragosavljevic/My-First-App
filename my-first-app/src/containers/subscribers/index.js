    ...
    return (
        <div>
            <div className="body">
                ...
                <a className="titleBottom title" href="#smartnetwork"><img src="images/Group.png" alt="" className='icon-nav'/>Smart Network</a>
                ...
                <a href="#taskmanager"><img src="images/Shape-1.png" alt="" className='icon-nav'/>Task Manager</a>
                <a href="#scriptlibrary"><img src="images/Shape-2.png" alt="" className='icon-nav'/>Script Library</a>
                <a href="#preferences"><img src="images/Shape-6.png" alt="" className='icon-nav'/>Preferences</a> 
                <a className="bottomBorder" href="#system"><img src="images/SYSTEM.png" alt="" className='icon-nav'/></a>
                ...
                <div className="container">
                    <div className="subscribers-div"><img src="images/user.png" alt="" className='subscribers-box'/><p className="subscribers-aligment">Subscribers</p> 
